        ...
        <div className="markets-schedule-wrapper">
          ...
          <div className="schedule-wrapper">
            <Paper>
              ...
              <Typography variant="body1" align="center">
                Bring your pet in costume...prizes will be awarded! Music From
                JB Duo
              </Typography>
            </Paper>
          </div>
          ...
          <div className="schedule-wrapper">
            <Paper>
              ...
              <Typography variant="body1" align="center">
                ...
                Treat at the Vendor Booths. There will be a costume contest and
                a lot of fun! Music From Idaho Arts Charter School
              </Typography>
            </Paper>
          </div>
        </div>
