      ...
      <Card elevation={3}>
        ...
        <CardContent style={{ backgroundColor: "#caa6ab" }}>
          <Typography variant="body1" style={{ color: "#344e6f" }}>
            ...
            dolores minima eos, iusto odio mollitia, cupiditate dolore magni
            enim accusantium. Illo excepturi officiis possimus culpa asperiores
            vitae a, ipsum tempora et.
            <br />
            <br />
